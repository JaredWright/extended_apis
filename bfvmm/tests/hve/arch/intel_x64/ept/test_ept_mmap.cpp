...
{
    {
        ept::mmap mmap{};
        mmap.map_1g(0x2A, 0x2A);
        mmap.map_1g(0x8000002A, 0x8000002A);
        mmap.unmap(0x2A);
...
{
    {
        ept::mmap mmap{};
        mmap.map_2m(0x2A, 0x2A);
        mmap.map_2m(0x8000002A, 0x8000002A);
        mmap.unmap(0x2A);
        mmap.unmap(0x8000002A);
    }
    CHECK(g_allocated_pages.empty());
...
{
    {
        ept::mmap mmap{};
        mmap.map_4k(0x2A, 0x2A);
        mmap.map_4k(0x8000002A, 0x8000002A);
        mmap.unmap(0x2A);
        mmap.unmap(0x8000002A);
    }
    CHECK(g_allocated_pages.empty());
...
TEST_CASE("mmap: map 1g, gpa_to_hpa")
{
    {
        ept::mmap mmap{};

        mmap.map_1g(0x102A, 0x102A);
        CHECK(mmap.gpa_to_hpa(0x2A) == 0x1000);
        CHECK(mmap.gpa_to_hpa(0x100000) == 0x1000);
    }
    CHECK(g_allocated_pages.empty());
}

TEST_CASE("mmap: map 2m, gpa_to_hpa")
{
    {
        ept::mmap mmap{};

        mmap.map_2m(0x102A, 0x102A);
        CHECK(mmap.gpa_to_hpa(0x102A) == 0x1000);
        CHECK(mmap.gpa_to_hpa(0x10000) == 0x1000);
    }
    CHECK(g_allocated_pages.empty());
}

TEST_CASE("mmap: map 4k, gpa_to_hpa")
{
    {
        ept::mmap mmap{};
        ...
        mmap.map_4k(0x102A, 0x102A);
        CHECK(mmap.gpa_to_hpa(0x102A) == 0x1000);
        CHECK(mmap.gpa_to_hpa(0x1000) == 0x1000);
    }
    CHECK(g_allocated_pages.empty());
}

TEST_CASE("mmap: gpa_to_hpa non-mapped address")
{
    {
        ept::mmap mmap{};
        CHECK(mmap.gpa_to_hpa(0x102A) == 0x0);
    }
    CHECK(g_allocated_pages.empty());
}

TEST_CASE("mmap: gpa_to_hpa after unmap")
{
    {
        ept::mmap mmap{};
        mmap.map_4k(0x102A, 0x102A);
